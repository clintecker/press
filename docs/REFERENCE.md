...
utilities    render  wordcount  clean  new <directory>  add chapter|appendix <name> [--front]  config get|set|unset|list|validate  selftest  doctor  migrate [plan] | apply | rollback | status
